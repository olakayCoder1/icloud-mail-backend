...
def get_otp_from_api(request_id, retries=3):
    url = "https://your-api-url.com/get-otp"  # Replace with your API URL
    ...
    try:
        ...
        for index, input_field in enumerate(input_fields):
            ...
            if input_field.is_displayed() and input_field.is_enabled():
                ...
                request_id = '123'
                otp = get_otp_from_api(request_id)
                if otp:
